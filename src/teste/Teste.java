...
public class Teste {
	...
	public static void main(String[] args) throws ParseException {
        ...
        animalDeEstimacao animalDeEstimacao = new AnimalDeEstimacao(Especie.CANINO, Raca.raca, "Juca", diaMesAno.parse("10/08/2021"), Sexo.MASCULINO);
        Vacina vacina = new Vacina("V10", diaMesAno.parse("11/12/2022"), "7589685455", "Elevencell", true, "6", Intervalo.MESES); 
